...
with open('/Users/mujthaba/Documents/DiabeticsPredictionApp/classifier_model.pkl', 'rb') as model_file:
    classifier = pickle.load(model_file)
with open('/Users/mujthaba/Documents/DiabeticsPredictionApp/scaler_model.pkl', 'rb') as scaler_file:
